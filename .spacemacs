...
you should place your code here."
  ...
  ;; Hide the minor mode icons
  (spaceline-toggle-minor-modes-off)

  ;; Load Scribble
  (load "~/emacs/scribble.el")

  ;; Load Pyret
  (load "~/git/pyret-lang/tools/emacs/pyret.el")

  ;; Register Pollen extension as Scribble
  (setq auto-mode-alist (cons '("\\.pm" . scribble-mode) auto-mode-alist))
  ...
  ;; Somehow the pdf binding is lost. Recover back
  ;; From: https://github.com/emacs-evil/evil-collection/blob/master/evil-collection-pdf.el
